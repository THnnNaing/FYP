            ...
            <ul class="nav">
                @auth
                    @if(auth()->user()->user_type === 'admin')
                        ...
                        <li class="nav-item has-submenu">
                            <a href="#" class="nav-link" data-bs-toggle="collapse" data-bs-target="#payroll-settings-submenu">
                                <i class="bi bi-gear-fill"></i>
                                <span>Payroll Settings</span>
                                <i class="submenu-toggle bi bi-chevron-down"></i>
                            </a>
                            <ul class="submenu collapse {{ Route::is('payroll_settings.*') ? 'show' : '' }}" id="payroll-settings-submenu">
                                <li>
                                    <a href="{{ route('payroll_settings.index') }}" class="nav-link {{ Route::is('payroll_settings.index') ? 'active' : '' }}">
                                        <span>View Settings</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('payroll_settings.create') }}" class="nav-link {{ Route::is('payroll_settings.create') ? 'active' : '' }}">
                    ...
                    @elseif(auth()->user()->user_type === 'hr')
                        ...
                        <li class="nav-item has-submenu">
                            <a href="#" class="nav-link" data-bs-toggle="collapse" data-bs-target="#payrolls-submenu">
                                <i class="bi bi-cash-stack"></i>
                                <span>Payrolls</span>
                                <i class="submenu-toggle bi bi-chevron-down"></i>
                            </a>
                            <ul class="submenu collapse {{ Route::is('hr.payrolls.*') ? 'show' : '' }}" id="payrolls-submenu">
                                <li>
                                    <a href="{{ route('hr.payrolls.index') }}" class="nav-link {{ Route::is('hr.payrolls.index') ? 'active' : '' }}">
                                        <span>View Payrolls</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('hr.payrolls.create') }}" class="nav-link {{ Route::is('hr.payrolls.create') ? 'active' : '' }}">
                    ...
                    @else
                        ...
                        @if(auth()->user()->employee)
                            ...
                            <li class="nav-item has-submenu">
                                ...
                                <ul class="submenu collapse {{ Route::is('employee.payrolls.*') ? 'show' : '' }}" id="payrolls-submenu">
                                    <li>
                                        <a href="{{ route('employee.payrolls.index') }}" class="nav-link {{ Route::is('employee.payrolls.index') ? 'active' : '' }}">
